    ...
    static let all: [HelpTopic] = [
        ...
        HelpTopic(
            ...
            paragraphs: [
                ...
                "With Manual sorting and at least two items, Edit appears after the item count and before the rows. Activate Edit, use the system’s reorder controls to move items within their group, then activate Done Editing. Unpinned documents and folders can be mixed. Clear Search before reordering. Each folder remembers its order on this device; new items follow saved items alphabetically. Renaming preserves positions, and moving an item to another folder appends it to that folder’s saved order.",
