...
nonisolated enum CompilationHelp {
    ...
    static let paragraphs = [
        ...
        "If the output arrives as a ZIP, extract it before opening the document and keep the extracted files together so linked images and attachments remain available. Format-specific topics below explain Word styles, presentation structure, ebook output, and braille settings."
    ]
}
