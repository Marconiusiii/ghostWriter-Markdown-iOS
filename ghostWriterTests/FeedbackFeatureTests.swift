...
struct FeedbackFeatureTests {
    @Test func exclusionDefaultsPersistAndFollowFolderLifecycle() throws {
        ...
        #expect(metadata.inclusionActionLabel(for: file) == "Exclude from Compilations")
        #expect(metadata.toggleDefaultInclusion(for: file) == "Notes.md excluded")
        #expect(metadata.toggleDefaultInclusion(for: folder) == "Book excluded")
        ...
        #expect(restored.inclusionActionLabel(for: file) == "Include in Compilations")
        ...
        #expect(restored.toggleDefaultInclusion(for: moved) == "Draft included")
        #expect(restored.inclusionActionLabel(for: moved) == "Exclude from Compilations")
        #expect(restored.isIncludedByDefault(moved))
        #expect(!restored.isIncludedByDefault(moved.appendingPathComponent("Notes.md")))
